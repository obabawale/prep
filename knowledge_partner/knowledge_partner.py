...
class knowledge_partner(osv.osv):
    _name = "knowledge.partner"
    _rec = "partner_id"
    _columns = {
        ...
        'utensils' : fields.selection([('yes','YES'),('no','NO'),('idk','Dont know')],'j. Sharing eating utensils with person who has HIV'),
        ...
        'PrEPtime' : fields.selection([('yes','YES'),('no','NO'),('idk','Dont know')],'j. Taking PrEP time to time'),
    }
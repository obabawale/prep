...
class followup_who(osv.Model):
    ...
    'asymptotic': fields.boolean('Asymptotic HIV infection'),
    ...
    'mucocutaneous':fields.boolean('Minor mucocutaneous manifestations (seborrheic dermatitis, prurigo, fungal nail infection, recurrent oral ulcerations, angular cheilitis)'),
  	...
  	'CNSlymphoma':fields.boolean('Primary CNS lymphoma or B cell non-Hodgkins Lymphoma'),
  	...
  	'Kaposissarcoma':fields.boolean('Kaposis sarcoma'),
